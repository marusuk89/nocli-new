...
class CommandServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SendCommand = channel.unary_unary(
                '/message.CommandService/SendCommand',
...
def add_CommandServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'message.CommandService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('message.CommandService', rpc_method_handlers)
